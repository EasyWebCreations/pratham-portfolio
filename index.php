...
<head>
    ...
    <meta name="twitter:title" content="Prathmesh Choudhari" />
    <meta name="twitter:image" content="./picture1.jpg" />
    <meta name="twitter:url" content="https://www.linkedin.com/in/prathmesh-choudhari-943769170/" />
...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <h2><a href="#" class="nav_logo">Prathmesh Choudhari</a></h2>
            ...
            <div class="nav_menu" id="nav-menu">
                <ul class="nav_list grid">
                    ...
                    <li class="nav_item">
                        <a href="#awards" class="nav_link">
                            <i class="uil uil-briefcase-alt nav_icon"></i>Certifications
                        </a>
                    </li>
                    <li class="nav_item">
                        <a href="#contact" class="nav_link">
                            <i class="uil uil-message nav-icon nav_icon"></i>Contact
                        </a>
                    </li>
                </ul>
    ...
    <main class="main">
            ...
            <div class="home_container container grid">
                <div class="home_content grid">
                    <div class="home_social">
                        ...
                        <a href="https://github.com/iampratham29/" class="home_social-icon" target="_blank">
                            <i class="uil uil-github-alt"></i>
                        </a>

                        <a href="https://twitter.com/pratham_uvaach" class="home_social-icon" target="_blank">
                            <i class="uil uil-twitter-alt"></i>
                        </a>

                        <a href="https://www.instagram.com/iampratham_29/" class="home_social-icon" target="_blank">
                    ...
                    <div class="home_data">
                        <h1 class="home_title">Hello, I'm Prathmesh</h1>
                        <h3 class="home_subtitle">
                            <span class="typewriter"></span> interest me
                        </h3>

                        <p class="home_description">
                            A Sotware Deevloper and Researcher, who loves to make technology accessible for common
                            people.
                        </p>
        ...
        <section class="about section" id="about">
            ...
            <div class="about_container container grid">
                <img src="./picture1.jpg" height="120px" width="120px" style="border-radius: 50%;" class="about_img" />
                <div class="about_data">
                    <p class="about_description">
                        Hello. I'm Prathmesh, a 22-year-old Computer Engineer. I'm an aspiring Full-stack
                        developer, a Machine Learning Researcher & I am exploring Salesforce Development at Persistent
                        Systems, Pune
                    </p>
                ...
                <div class="skill skills_content skills_open">
                    <div class="skills_header">
                        ...
                        <div>
                            ...
                            <span class="skills_subtitle">Skills I have picked up over the years</span>
                        </div>
                ...
                <div class="skill skills_content">
                    <div class="skills_header">
                        ...
                        <div>
                            ...
                            <span class="skills_subtitle">Tools I know and use on a daily basis</span>
                        </div>
                    ...
                    <div class="skills_list grid">
                        ...
                        <div class="skills_data">
                            <div class="skills_titles">
                                ...
                                <h3 class="skills_name">GitLab and GitHub</h3>
                            </div>
                            <div class="skills_bar"></div>
                        </div>
        ...
        <section class="qualification section" id="qualification">
            ...
            <span class="section_subtitle">My Educational Qualification & Work Experience</span>
                ...
                <div class="qualification_sections">
                    ...
                    <div class="qualification_content qualification_active" data-content id="education">
                        ...
                        <div class="qualification_data">
                            <div>
                                <h3 class="qualification_title">B.E, Computer Science</h3>
                                <span class="qualification_subtitle">VIT, Pune</span>
                        ...
                        <div class="qualification_data">
                            ...
                            <div>
                                <h3 class="qualification_title">Honors, AI & DA</h3>
                                <span class="qualification_subtitle">VIT, Pune</span>
                                <div class="qualification_calendar">
                        ...
                        <div class="qualification_data">
                            <div>
                                <h3 class="qualification_title">Higschool Education (12th)</h3>
                                <span class="qualification_subtitle">Sharada Mahavidyalaya, Parbhani </span>
                                <div class="qualification_calendar">
                        ...
                        <div class="qualification_data">
                            ...
                            <div>
                                <h3 class="qualification_title">Senior Secondary Education (10th)</h3>
                                <span class="qualification_subtitle">Bal Vidya Mandir Higschool, Parbhani</span>
                                <div class="qualification_calendar">
                    ...
                    <div class="qualification_content qualification-inactive" data-content id="work">
                        ...
                        <!-----------------AirMenus Operations Lead  ---------------->

                        <div class="qualification_data">
                            <div>
                                <h3 class="qualification_title">Software Engineer</h3>
                                <span class="qualification_subtitle"><i>Full Time</i><br>Persistent Systems, Pune</span>
                                <div class="qualification_calendar">
                                    <i class="uil uil-calendar-alt"></i> June 2022 - Present
                                </div>
                            </div>
                        ...
                        <div class="qualification_data">
                            ...
                            <div>
                                <h3 class="qualification_title">Software Developer Intern</h3>
                                <span class="qualification_subtitle"><i>Internship</i><br>Persistent Systems,
                                    Pune</span>
                                <div class="qualification_calendar">
                                    <i class="uil uil-calendar-alt"></i> Jan 2022 - June 2022
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="qualification_data">
                            <div>
                                <h3 class="qualification_title">Web Developer and Instructor</h3>
                                <span class="qualification_subtitle"><i>Co-founder</i><br>Easy Code Classes, Pune</span>
                                <div class="qualification_calendar">
                                    <i class="uil uil-calendar-alt"></i> Jan 2021 - May 2022
                                </div>
                            </div>
                        ...
                        <div class="qualification_data">
                            ...
                            <div>
                                <h3 class="qualification_title">Machine Learning Researcher</h3>
                                <span class="qualification_subtitle"><i>Internship</i><br>Symbiosis International
                                    Uniersity,
                                    Pune(Remote)</span>
                                <div class="qualification_calendar">
                                    <i class="uil uil-calendar-alt"></i> July 2021 - November 2021
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="qualification_data">
                            <div>
                                <h3 class="qualification_title">Machine Learning Expert</h3>
                                <span class="qualification_subtitle"><i>Part Time</i><br>The Robotics Forum, VIT
                                    Pune</span>
                                <div class="qualification_calendar">
                                    <i class="uil uil-calendar-alt"></i> May 2020 - November 2020
                                </div>
                            </div>
        ...
        <section class="portfolio section" id="projects">
            ...
            <span class="section_subtitle">Here are some of my projects awesome Projects!</span>
            ...
            <div class="portfolio_container container swiper-container swiper mySwiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="portfolio_content grid swiper-slide">
                        <img src="./prasako.JPG" alt="" class="portfolio_img">

                        <div class="portfolio_data">
                            <h3 class="portfolio_title">
                                Prasako: Virtual Trial Room
                            </h3>
                            <p class="portfolio_description">
                                - Developed a neural network which gives virtual garment wear experience on image of the
                                user.<br>
                    ...
                    <!-- Project 2 -->
                    <div class="portfolio_content grid swiper-slide">
                        <img src="./space_vaarta.JPG" alt="" class="portfolio_img">

                        <div class="portfolio_data">
                            <h3 class="portfolio_title">
                                SpaceVaarta - SIH National Level, ISRO
                            </h3>
                            <p class="portfolio_description">
                                An algorithm that can be used for ISRO's <i>Gagan-Yaan</i> Project. <br>It attempts to
                    ...
                    <!-- Project 3 -->
                    <div class="portfolio_content grid swiper-slide">
                        <img src="./hr_management.JPG" alt="" class="portfolio_img">

                        <div class="portfolio_data">
                            <h3 class="portfolio_title">
                                TEE: HR & Payroll Software
                            </h3>
                            <p class="portfolio_description">Offline Software for a Builder's firm so that he could
                                manage his work
                                <li>
                                    <ul>- Add/Edit/Delete Employee Details</ul>
                                    <ul>- Record Attendance</ul>
                                    <ul>- Calculate Salary with HRA, PF </ul>
                                    <ul>- Generate Payment Reports (Site wise, Rank wise, etc)</ul>
                    ...
                    <!-- Project 4 -->
                    <div class="portfolio_content grid swiper-slide">
                        <img src="./cobb_finder.JPG" alt="" class="portfolio_img">
                        ...
                        <div class="portfolio_data">
                            ...
                            <p class="portfolio_description">
                                A Neural network that could help doctors for dignosis of Scoliosis. It takes X-ray input
                    ...
                    <div class="portfolio_content grid swiper-slide">
                        ...
                        <div class="portfolio_data">
                            <h3 class="portfolio_title">
                                HanDriver: AI Based Arcade Car Game
                            </h3>
                            <p class="portfolio_description">
                                A car game that operates on Hand Gestures of the user.
        ...
        <section class="contact section" id="contact">
            ...
            <span class="section_subtitle">
                Wish to connect? My inbox is always open!
            </span>

            <div class="contact_container container grid">
                <div>
                    <a href="choudhariprathmesh001@gmail.com" target="_blank">
                        <div class="contact_info">
                            <i class="uil uil-envelope-alt contact_icon"></i>
                            <div>
                                <h3 class="contact_title">Email</h3>
                                <span class="contact_subtitle">choudhariprathmesh001@gmail.com</span>
                            </div>
                        </div>
                    </a>

                    <a href="https://twitter.com/pratham_uvaach" target="_blank">
                        <div class="contact_info">
                            <i class="uil uil-twitter-alt contact_icon"></i>
                            <div>
                                <h3 class="contact_title">Twitter</h3>
                                <span class="contact_subtitle">@pratham_uvaach</span>
                            </div>
                        </div>
                    </a>
                </div>
        ...
        <!-- <script -->
        <!-- type="text/javascript">window.onload = function () { Calendly.initBadgeWidget({ url: 'https://calendly.com/gsarage19/30min?hide_event_type_details=1&hide_gdpr_banner=1', text: 'Schedule time with me', color: '#0069ff', textColor: '#ffffff', branding: true }); }</script> -->
    ...
    <footer class="footer">
        <div class="footer_bg">
            <div class="footer_container container grid">
                <div>
                    <h1 class="footer_title">Prathmesh Choudhari</h1>
                    <span class="footer_subtitle"><b>Software Developer and Researcher</b><br>Pune,
                ...
                <div class="footer_socials">
                    ...
                    <a href="https://github.com/iampratham29/" class="footer_social" target="_blank">
                        <i class="uil uil-github-alt"></i>
                    </a>

                    <a href="https://twitter.com/pratham_uvaach" class="footer_social" target="_blank">
                        <i class="uil uil-twitter-alt"></i>
                    </a>

                    <a href="https://www.instagram.com/iampratham_29" class="footer_social" target="_blank">
                        <i class="uil uil-instagram"></i>
                    </a>
                    </a>
                </div>
            ...
            <p class="footer_copy">&#169; Prathmesh Choudhari. All rights reserved</p>
        </div>
    </footer>
